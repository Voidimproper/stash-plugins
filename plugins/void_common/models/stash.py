...
class GalleryFile(BaseFile):
    ...
    updated_at: Time
    zip_file_id: Optional[ID] = None
    typename__: Optional[Literal['GalleryFile']] = Field('GalleryFile', alias='__typename')
...
class ImageFile(BaseFile):
    ...
    width: Int
    zip_file_id: Optional[ID] = None
    typename__: Optional[Literal['ImageFile']] = Field('ImageFile', alias='__typename')
...
class VideoFile(BaseFile):
    ...
    width: Int
    zip_file_id: Optional[ID] = None
    typename__: Optional[Literal['VideoFile']] = Field('VideoFile', alias='__typename')
